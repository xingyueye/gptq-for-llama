...
@torch.no_grad()
def llama_sequential(model, dataloader, dev, lr=1e-6):
    print('Starting ...')
    ...
    lr_schedule = lambda x : lr * (1 + x * (100. / len(layers)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('dataset', type=str, choices=['wikitext2', 'ptb', 'c4', 'qat_gen'], help='Where to extract calibration data from.')
